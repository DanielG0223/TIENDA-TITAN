...
class PedidoController extends Controller
{
 ...
 $pedidos = Compras::orderBy('fecha', 'desc')->paginate(10);
 } else {
 $pedidos = Compras::where('user_id', auth()->user()->id)->orderBy('fecha', 'desc')->paginate(10);
 }
 ...
 return to_route('productos.index')->with('info', 'Pedido realizado con éxito');
     ...
     */
    public function show(Compras $pedido)
    {
        //
    }
     ...
     */
    public function edit(Compras $pedido)
 {
 return view('pedidos.edit', ['pedido' => $pedido]);
     ...
     */
    public function update(Request $request, Compras $pedido)
 {
 ...
 return to_route('pedidos.index')->with('info', 'Se cambió el estado del pedido');
     ...
     */
    public function destroy(Compras $pedido)
    {
